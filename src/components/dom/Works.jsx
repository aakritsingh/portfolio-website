        ...
        <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            ...
            >
                <div className='relative w-full h-[230px]'>
                    <div className="w-full h-full bg-indigo-900 rounded-2xl flex items-center justify-center text-4xl font-bold opacity-50">
                    ...
                    <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
                        ...
                        >
                            <div className="text-sm font-bold">GH</div>
                        </div>
                    </div>
                </div>
